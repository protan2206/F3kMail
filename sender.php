...
<head>
    ...
    <title>Mail Sender | Status</title>
...
<body class="bg-dark">
    ...
    <div class="container">
        ...
        <div class="w-100 alert alert-danger text-center" role="alert">
            Do it for Fun. Do not MissUse it.
        </div>
...
<div class="font-weight-bold alert alert-success" role="alert">
    <p class="h2">Email has been Sent.</p>
</div>';
}
else {
echo '
<div class="font-weight-bold alert alert-success" role="alert">
    <p class="h2">Email Not been Sent.</p>
</div>';
}

echo '
<div class="d-flex justify-content-center">
    <a class="btn btn-primary" href="index.html">Sent Another</a>
</div>
